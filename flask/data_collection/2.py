...
def line_area_stack() -> Line:
        ...
        .add_yaxis('system_mem',
                ...
                areastyle_opts=opts.AreaStyleOpts(
                    ...
                    color=JsCode("""
                                    new echarts.graphic.LinearGradient(
                                        0, 0, 0, 1,
                                        [{offset: 0, color: 'rgba(225, 191, 50)'},
        ...
        .add_yaxis('total_mem',
                ...
                areastyle_opts=opts.AreaStyleOpts(
                    ...
                    color=JsCode("""
                                    new echarts.graphic.LinearGradient(
                                        0, 0, 0, 1,
                                        [{offset: 0, color: 'rgba(105, 191, 60)'},
                                        {offset: 1, color: 'rgba(224, 62, 76)'}],
                                        false)
                                    """)
                )
    ...
    line = Line()
    line.add_xaxis([1,2,3,4,5,6,7])
    #['java_mem', 'native_mem', 'code_mem', 'stack_mem', 'graph_mem', 'others_mem', 'system_mem', 'total_mem']
    line.add_yaxis('java_mem',
                [140, 232, 101, 264, 90, 340, 250],
                stack='stack',
                is_smooth=True,
                is_symbol_show=False,
...
def bar_bases() -> Bar:
    c = (
        ...
        .add_yaxis("商家A ", [randrange(0, 100) for _ in range(8)])
